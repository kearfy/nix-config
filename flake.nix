{
    ...
    outputs = inputs @ { self, nix-darwin, nixpkgs, home-manager, nix-homebrew, homebrew-core, homebrew-cask, homebrew-bundle, nix-vscode-extensions }:
        let darwinConfiguration = { pkgs, lib, config, ... }: {
